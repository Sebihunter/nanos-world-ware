...
function spawnMap()
	local mapParts = {
		--Floor
		{Vector(0,0, 1000), Rotator(0, 0, 0), Vector(60,60,2), Color(0.93,0.662,0.002,1),  "nanos-world::SM_Cube"},
		--Walls
		{Vector(3000,0, 1000), Rotator(-3, 0, 0),Vector(1,60,20),  Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(-3000,0, 1000), Rotator(3, 0, 0),Vector(1,60,20),  Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(0,3000, 1000), Rotator(0, 0, 3), Vector(60,1,20),  Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(0,-3000, 1000), Rotator(0, 0, -3), Vector(60,1,20),  Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},		
		--Walls Upper Edge
		{Vector(3000,0, 2000), Rotator(0, 0, 0), Vector(3,60,1),  Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(-3000,0, 2000), Rotator(0, 0, 0), Vector(3,60,1),  Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(0,3000, 2000), Rotator(0, 0, 0), Vector(60,3,1),  Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(0,-3000, 2000), Rotator(0, 0, 0), Vector(60,3,1),  Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		--Wall Corners
		{Vector(3000, -3000, 1000), Rotator(0,0,0); Vector(2,2,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(-3000, -3000, 1000), Rotator(0,0,0); Vector(2,2,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(3000, 3000, 1000), Rotator(0,0,0); Vector(2,2,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(-3000, 3000, 1000), Rotator(0,0,0); Vector(2,2,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		--Wall Collumns
		{Vector(3000, -2000, 1000), Rotator(0,0,0); Vector(1,3,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(3000, -1000, 1000), Rotator(0,0,0); Vector(1,3,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(3000, 0, 1000), Rotator(0,0,0); Vector(1,3,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(3000, 1000, 1000), Rotator(0,0,0); Vector(1,3,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(3000, 2000, 1000), Rotator(0,0,0); Vector(1,3,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(-3000, -2000, 1000), Rotator(0,0,0); Vector(1,3,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(-3000, -1000, 1000), Rotator(0,0,0); Vector(1,3,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		...
		{Vector(-3000, 1000, 1000), Rotator(0,0,0); Vector(1,3,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(-3000, 2000, 1000), Rotator(0,0,0); Vector(1,3,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},	
		{Vector(2000, 3000, 1000), Rotator(0,0,0); Vector(3,1,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(1000, 3000, 1000), Rotator(0,0,0); Vector(3,1,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(0, 3000, 1000), Rotator(0,0,0); Vector(3,1,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(-1000, 3000, 1000), Rotator(0,0,0); Vector(3,1,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(-2000, 3000, 1000), Rotator(0,0,0); Vector(3,1,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},		
		{Vector(2000, -3000, 1000), Rotator(0,0,0); Vector(3,1,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
		{Vector(1000, -3000, 1000), Rotator(0,0,0); Vector(3,1,20), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube"},
	...
	for i=-2000,2000,1000 do
		for j=-2000,2000, 1000 do
			table.insert(mapParts, {Vector(i, j, 1051), Rotator(0,0,0), Vector(8,8,1), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube_VR_02"})
			table.insert(mapParts, {Vector(i, j, 1000), Rotator(0,0,0), Vector(2,2,4.3), Color(0.9,0.9,0.9,0),  "nanos-world::SM_Cube_VR_02"})
		end
	end
...
function startMinigame()
	...
	for i = 1, 5, 1 do --pseudocode
		table.insert(wareTimers, Timer.SetTimeout(function(i)
		...
		end, gameDuration*i, i))
	end	
	if wareGame ~= 15 then --if not maths broadcast the objective
	...
	elseif wareGame == 10 then --Punch the robot
		...
		if chr and chr:IsValid() then
			...
			chr:Destroy()
			local new_char = Character(position, rotation,"nanos-world::SK_Mannequin")
	...
	elseif wareGame == 13 then
		...
		local MyProp = Grenade(pos,Rotator(0, 0, 0),"nanos-world::SM_OilDrum","nanos-world::P_Explosion_Dirt","nanos-world::A_Explosion_Large")
		MyProp:SetMaterialColorParameter("Tint", Color(1,0.0,0.0,1))
		MyProp:SetScale(Vector(3,3,3))
		MyProp:SetDamage(100, 0, 3000, 1000, 1)
		table.insert(macrogame_objects, MyProp)
table.insert(macrogame_objects, MyProp)		
	elseif wareGame == 14 then
		local MyProp = Prop(spawn_locations[math.random(#spawn_locations)], Rotator(), "nanos-world::SM_Cylinder")
		MyProp:SetCollision(0)
	...
	table.insert(wareTimers, Timer.SetTimeout( function()
		endMinigame()
	end, wareGames[wareGame][2]))
...
Character.Subscribe("Respawn", function(character)
	character:SetLocation(spawn_locations[math.random(#spawn_locations)])
end)

-- When Player Unpossess a Character (when player is unpossessing because is disconnecting 'is_player_disconnecting' = true)
Player.Subscribe("Destroy", function(player, character, is_player_disconnecting)
	local character = player:GetControlledCharacter()
	if (character) then
			character:Destroy()
